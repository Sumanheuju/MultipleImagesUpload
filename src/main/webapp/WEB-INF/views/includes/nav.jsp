<div class="wsmenucontainer clearfix">
  ...
  <div class="wsmobileheader clearfix">
      ...
      <a class="smallogo"><img src="images/sml-logo.png"  alt="small image" /></a>
    ...
    <div class="wsmain">
      <nav class="wsmenu clearfix">
        <ul class="mobile-sub wsmenu-list">
          <li><a href="#" class="navtext"><span>Shop By</span> <span>Store</span></a>
              ...
              <ul class="wstabitem clearfix">
                      ...
                      <div class="wstbootslider clearfix">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner" role="listbox">
                            <div class="item active"> <a href="#"><img src="https://s-media-cache-ak0.pinimg.com/736x/c0/00/ca/c000ca8e7e79e6ac230cce235fce1225--korean-fashion-styles-korean-fashion-spring-street-styles.jpg" alt="" ></a>
                              <div class="carousel-caption">
                                <h3>First slide label</h3>
                              </div>
                            </div>
                            <div class="item"> <a href="#"><img src="https://s-media-cache-ak0.pinimg.com/736x/f5/30/6c/f5306ca6f3a5204c04977d9bdbb89937--denim-shirt-street-style-street-style-clothes.jpg" alt="" ></a>
                              <div class="carousel-caption">
                ...
                <li><a href="#"><i class="fa fa-female"></i> Men's Clothing &amp; Accessories</a>
                  <div class="wstitemright clearfix">
                    ...
                    <div class="wstmegamenucolr clearfix"><a href="#"><img src="images/man-ad-img.jpg" alt="" ></a></div>
                  </div>
                </li>
                <li><a href="#"><i class="fa fa-play-circle"></i> Movies, Music &amp; Games</a>
                  <div class="wstitemright clearfix">
                    ...
                    <div class="wstadsize01 clearfix"><a href="#"><img src="images/ad-size01.jpg" alt="" ></a></div>
                    <div class="wstadsize02 clearfix"><a href="#"><img src="images/ad-size02.jpg" alt="" ></a></div>
                  </div>
                </li>
                ...
                <li><a href="#"><i class="fa fa-heartbeat"></i>Health Care Products</a>
                  <div class="wstitemright clearfix wstpngsml">
                    <div class="wstmegamenucolr03 clearfix"> <img src="images/health-menu-img01.jpg" alt=""> </div>
          ...
          <li><a href="#" class="navtext"><span>Shop By</span> <span>Women</span></a>
          ...
          <li><a href="#" class="navtext"><span>Shop By</span> <span>Men</span></a>
          ...
          <li class="wsshopmyaccount clearfix"><a href="#" class="wtxaccountlink"><i class="fa fa-user-circle" aria-hidden="true"></i> <b>Account</b> <i class="fa  fa-angle-down"></i></a>
